 ...
 */
export type AgendaDocument<Lang extends string = string> = prismicT.PrismicDocumentWithoutUID<
	Simplify<AgendaDocumentData>,
	'agenda',
	Lang
>;
 ...
 * @typeParam Lang - Language API ID of the document.
 */
export type BeritaDocument<Lang extends string = string> = prismicT.PrismicDocumentWithUID<
	Simplify<BeritaDocumentData>,
	'berita',
	Lang
>;
 ...
 * @typeParam Lang - Language API ID of the document.
 */
export type GalleryDocument<Lang extends string = string> = prismicT.PrismicDocumentWithoutUID<
 ...
 * @typeParam Lang - Language API ID of the document.
 */
export type LayoutsDocument<Lang extends string = string> = prismicT.PrismicDocumentWithUID<
 ...
 * @typeParam Lang - Language API ID of the document.
 */
export type PagesDocument<Lang extends string = string> = prismicT.PrismicDocumentWithUID<
 ...
 * @typeParam Lang - Language API ID of the document.
 */
export type PengumumanDocument<Lang extends string = string> = prismicT.PrismicDocumentWithoutUID<
	Simplify<PengumumanDocumentData>,
	'pengumuman',
	Lang
>;
 ...
 * @typeParam Lang - Language API ID of the document.
 */
export type ProgramDocument<Lang extends string = string> = prismicT.PrismicDocumentWithUID<
 ...
 * @typeParam Lang - Language API ID of the document.
 */
export type RedirectLinkDocument<Lang extends string = string> = prismicT.PrismicDocumentWithUID<
 ...
 *
 */
interface AgendaPengumumanSliceDefaultPrimary {
	/**
	 * Tampilkan Semua field in *AgendaPengumuman → Primary*
	 *
	 * - **Field Type**: Boolean
	 * - **Placeholder**: *None*
	 * - **Default Value**: false
	 * - **API ID Path**: agenda_pengumuman.primary.tampilkanSemua
 ...
 *
 */
export type AgendaPengumumanSliceDefault = prismicT.SharedSliceVariation<
	'default',
	Simplify<AgendaPengumumanSliceDefaultPrimary>,
	never
>;
/**
 ...
 *
 */
export type AgendaPengumumanSlice = prismicT.SharedSlice<
	'agenda_pengumuman',
	AgendaPengumumanSliceVariation
>;
/**
 ...
 *
 */
export type ProfilSliceDefault = prismicT.SharedSliceVariation<
	'default',
	Simplify<ProfilSliceDefaultPrimary>,
	never
>;
/**
 ...
 *
 */
export type BeritaOverviewSliceDefault = prismicT.SharedSliceVariation<
	'default',
	Simplify<BeritaOverviewSliceDefaultPrimary>,
	never
>;
/**
 ...
 *
 */
export type BeritaOverviewSlice = prismicT.SharedSlice<
	'berita_overview',
	BeritaOverviewSliceVariation
>;
/**
 ...
 *
 */
export type ChildrenSliceDefault = prismicT.SharedSliceVariation<
	'default',
	Record<string, never>,
	never
>;
 ...
 *
 */
export type EkstraOverviewSliceDefault = prismicT.SharedSliceVariation<
	'default',
	Simplify<EkstraOverviewSliceDefaultPrimary>,
	never
>;
/**
 ...
 *
 */
export type EkstraOverviewSlice = prismicT.SharedSlice<
	'ekstra_overview',
	EkstraOverviewSliceVariation
>;
/**
 ...
 *
 */
export type FooterMainSliceDefault = prismicT.SharedSliceVariation<
	'default',
 ...
 *
 */
export type GalleryOverviewSliceDefault = prismicT.SharedSliceVariation<
	'default',
 ...
 *
 */
export type GalleryOverviewSlice = prismicT.SharedSlice<
	'gallery_overview',
 ...
 *
 */
export type KomiteGridSliceDefault = prismicT.SharedSliceVariation<
	'default',
	Simplify<KomiteGridSliceDefaultPrimary>,
	Simplify<KomiteGridSliceDefaultItem>
>;
/**
 ...
 *
 */
export type NavbarMainSliceDefault = prismicT.SharedSliceVariation<
	'default',
	Simplify<NavbarMainSliceDefaultPrimary>,
 ...
 *
 */
export type TentangSliceDefault = prismicT.SharedSliceVariation<
	'default',
	Simplify<TentangSliceDefaultPrimary>,
	never
>;
/**
 ...
 *
 */
export type TentangkamiSliceDefault = prismicT.SharedSliceVariation<
	'default',
	Simplify<TentangkamiSliceDefaultPrimary>,
	never
>;
/**
...
declare module '@prismicio/client' {
	...
	namespace Content {
		export type {
			...
			AgendaDocument,
			BeritaDocumentData,
			BeritaDocumentDataSlicesSlice,
			BeritaDocument,
			GalleryDocumentData,
			GalleryDocument,
			LayoutsDocumentData,
			LayoutsDocumentDataSlicesSlice,
			LayoutsDocument,
			PagesDocumentData,
			PagesDocumentDataSlicesSlice,
			PagesDocument,
			PengumumanDocumentData,
			PengumumanDocument,
			ProgramDocumentData,
			ProgramDocument,
			...
			ChildrenSlice,
			EkstraOverviewSliceDefaultPrimary,
			EkstraOverviewSliceDefault,
			EkstraOverviewSliceVariation,
			EkstraOverviewSlice,
			FooterMainSliceDefaultPrimary,
			FooterMainSliceDefaultItem,
			...
			ImageSliceVariation,
			ImageSlice,
			KomiteGridSliceDefaultPrimary,
			KomiteGridSliceDefaultItem,
			KomiteGridSliceDefault,
			KomiteGridSliceVariation,
			KomiteGridSlice,
			NavbarMainSliceDefaultPrimary,
			NavbarMainSliceDefaultItem,
			...
			ParagraphSlice,
			TentangSliceDefaultPrimary,
			TentangSliceDefault,
			TentangSliceVariation,
			TentangSlice,
			TentangkamiSliceDefaultPrimary,
			TentangkamiSliceDefault,
			TentangkamiSliceVariation,
			TentangkamiSlice
		};
	}
}
